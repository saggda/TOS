          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="glass-card p-8 md:p-12 prose prose-lg max-w-none">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.1. Персональные данные</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.2. Данные, собираемые автоматически</h3>
                <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">2.3. Иные данные</h3>
                <p className="text-gray-700 leading-relaxed">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4">4. Правовая основа обработки</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4">5. Условия обработки данных</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                ...
                <h3 className="text-xl font-semibold mb-3 mt-6">Третьи лица, которым могут передаваться данные:</h3>
                <ul className="list-disc pl-6 text-gray-700">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4">8. Права пользователей</h2>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-bold mb-4">9. Изменение Политики</h2>
                <p className="text-gray-700 leading-relaxed">
