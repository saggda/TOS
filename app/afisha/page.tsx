...
export default async function AfishaPage() {
  ...
  return (
    <Container className="py-8 sm:py-12">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-6 sm:mb-8 text-white drop-shadow-lg">Афиша</h1>

      {events.length === 0 ? (
        <div className="text-center py-12">
          <p className="text-white/70 text-base sm:text-lg">Событий пока нет</p>
        </div>
      ) : (
