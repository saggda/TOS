    ...
    >
      ...
      >
        ...
        <div className="p-4 sm:p-6">
          ...
          <h3 className="font-display font-bold text-lg sm:text-xl mb-2 group-hover:text-brand-red group-active:text-brand-red transition-colors duration-300 line-clamp-2">
            {event.title}
          </h3>
          ...
          <div className="flex items-center gap-2 text-brand-red text-xs sm:text-sm font-medium opacity-0 group-hover:opacity-100 group-active:opacity-100 transition-opacity duration-300 transform translate-z-10">
            <span>Подробнее</span>
